...
function renderBoard(board) {
    ...
    document.title = 'task | ' + currentBoard().name;
...
function saveData() {
    window.localStorage.setItem('task-appData', JSON.stringify(appData));
}

function getDataFromLocalStorage() {
    return window.localStorage.getItem('task-appData');
}

function loadData() {
    let _data = window.localStorage.getItem('task-appData');
    if (_data) {
